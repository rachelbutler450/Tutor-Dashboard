import type { ReviewStatus, SessionPerformance } from "@/lib/types";
...
export function PerformanceBadge({
  ...
  return (
    <span className={`${BASE} ${PERFORMANCE_STYLES[performance]}`}>
      {performance}
    </span>
  );
}
